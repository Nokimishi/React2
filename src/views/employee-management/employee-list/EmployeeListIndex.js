      ...
      <CCol xs="12">
        <CCard>
          <CCardHeader className="bg-primary">
           <h4 className='m-0 text-center'>Employee List</h4>
          </CCardHeader>
          <CCardBody>
          ...
          {showConfirm && (
              <div className="confirm-dialog">
                ...
                <CButton className="form-btn" onClick={() => handleConfirm(true)}>Yes</CButton>
                <CButton className="form-btn" onClick={() => handleConfirm(false)}>No</CButton>
              </div>
            )}
        </CCard>
      </CCol>
